  ...
  */
  relevant: async (req, res, next) => {
    ...
    try {
      ...
      return res.status(200).send({ message: "Relevant posts retrieved", data: [ ...relevantPostsByFollowings, ...relevantPostsByLikedPostsInSameCategory, ...relevantPostsByLikedPostsTags ] });
    } catch (err) {
      next(err);
    }
  },
